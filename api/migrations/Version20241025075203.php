 ...
 */
final class Version20241025075203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE passager (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, nom VARCHAR(100) DEFAULT NULL, prenom VARCHAR(100) DEFAULT NULL, email VARCHAR(200) DEFAULT NULL, telephone VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id))');
